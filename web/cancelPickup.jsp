...
<body>
	<font color="blue"><center><h1><u><i>Cancel pickup</i></u></h1></center></font>
	<s:form action="cancelPickupConfirm" method="post">
		...
		<s:div cssClass="actions">
			...
			<s:submit id="submit" button="true" align="center" value="Cancel Pickup" theme="simple"/>
		</s:div>
	</s:form>
</body>
</html>