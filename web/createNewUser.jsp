...
<body>
	...
	<fieldset id="inputs">
		...
		<s:textfield id="userName" key="employee.emailID" dataType="String" label="Email id "></s:textfield>
		...
		<s:textfield id="firstName" key="employee.firstName" label="First Name "></s:textfield>
